<div class="min-h-screen flex flex-col justify-between bg-gradient-to-b from-indigo-50 via-white to-white">
    @if(!auth()->check())
        <main class="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg sm:text-xl text-gray-700 mb-8 max-w-2xl mx-auto animate-fade-in delay-200">Controle seu bolso de forma simples e inteligente. Organize suas contas, categorias e transações em um só lugar!</p>
            <div class="flex flex-wrap justify-center gap-4 mt-6">
                <a href="{{ route('cadastro') ?? '#' }}" class="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 text-white font-semibold shadow hover:from-indigo-700 hover:to-blue-700 transition">Criar conta grátis</a>
                <a href="{{ route('login') }}" class="px-6 py-3 rounded-xl border border-indigo-600 text-indigo-700 font-semibold hover:bg-indigo-50 transition">Entrar</a>
            </div>
            <div class="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
                <div class="p-6 bg-white rounded-2xl shadow hover:shadow-lg transition">
                    ...
                    <p class="mt-2 text-gray-500 text-sm">Auto-sugestão por descrição e valor para facilitar o seu controle.</p>
                </div>
                <div class="p-6 bg-white rounded-2xl shadow hover:shadow-lg transition">
                    <h3 class="text-lg font-semibold text-gray-900">Relatórios claros</h3>
                    <p class="mt-2 text-gray-500 text-sm">Visualize gráficos por mês, conta e categoria para decisões rápidas.</p>
                </div>
                <div class="p-6 bg-white rounded-2xl shadow hover:shadow-lg transition">
                    <h3 class="text-lg font-semibold text-gray-900">Metas e alertas</h3>
                    <p class="mt-2 text-gray-500 text-sm">Receba notificações e defina limites para manter suas finanças no azul.</p>
                </div>
            </div>
        </main>
    @endauth
